...
namespace  AltUI.ColorPicker
{
  ...
  public partial class ColorPickerDialog : Forms.DarkForm
  {
    ...
    public ColorPickerDialog()
    {
      ...
      colorEditor.BackColor = AltUI.Config.ThemeProvider.BackgroundColour;
    ...
    {
      add => Events.AddHandler(_eventCustomColorsLoading, value);
      remove => Events.RemoveHandler(_eventCustomColorsLoading, value);
    }

    [Category("Action")]
    public event EventHandler CustomColorsSaving
    {
      add => Events.AddHandler(_eventCustomColorsSaving, value);
      remove => Events.RemoveHandler(_eventCustomColorsSaving, value);
    }

    [Category("Property Changed")]
    public event EventHandler PreviewColorChanged
    {
      add => Events.AddHandler(_eventPreviewColorChanged, value);
      remove => Events.RemoveHandler(_eventPreviewColorChanged, value);
    }
    ...
    protected virtual void OnCustomColorsLoading(CancelEventArgs e)
    {
      ...
      handler = (CancelEventHandler)Events[_eventCustomColorsLoading];
    ...
    protected virtual void OnCustomColorsSaving(EventArgs e)
    {
      ...
      handler = (EventHandler)Events[_eventCustomColorsSaving];
    ...
    protected virtual void OnPreviewColorChanged(EventArgs e)
    {
      ...
      handler = (EventHandler)Events[_eventPreviewColorChanged];
